...
{
"name": "OS Event Example",
"example": REPO_ROOT / "examples" / "os-event.example.yaml",
"schema": REPO_ROOT / "schemas" / "os-event.schema.json",
},
{
"name": "Governance Action Example",
"example": REPO_ROOT / "examples" / "governance-action.example.yaml",
"schema": REPO_ROOT / "schemas" / "governance-action.schema.json",
},
]
